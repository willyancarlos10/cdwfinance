            ...
            <div class="row d-flex justify-content-center">
              <div class="col-12 col-sm-8">
                ...
                <div class="col-12 col-sm-12">
                  <?php $x = explode(" ", $user->name); ?>
                  <p class="lead">Seja bem-vindo de volta <strong><?php echo html_escape($x[0]); ?></strong>. <br />Informe sua nova senha de acesso nos campos abaixo:</p>
                </div>
                ...
                <form action="<?php echo current_url(); ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="forgot_token" value="<?php echo html_escape($forgot_token); ?>">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="password" name="passw1" required class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-label mb-1">Confirmar senha</label>
                        <div class="input-group mb-3">
                          <span class="input-group-text"><i class="fa fa-lock"></i></span>
                          <input type="password" name="passw2" required class="form-control">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                  ...
                  <div class="text-center mt-3">
                    <button type="submit" class="btn btn-lg btn-primary"><i class="mdi mdi-content-save"></i> SALVAR NOVA SENHA</button>
                  </div>
                </form>
